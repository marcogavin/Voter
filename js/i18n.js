...
const strings = {
  en: {
    ...
    attendeesHint: "Attendees open the audience page on their phones",
  ...
  pt: {
    ...
    addOptionsFirst: "Adicione opções acima para marcar a certa.",
    addQuestion: "Adicionar pergunta",
    saveChanges: "Guardar alterações",
    cancel: "Cancelar",
    noQuestionsYet: "Ainda sem perguntas — adicione a primeira acima.",
    optionsCount: "{n} opções",
    needTwoOptions: "Mínimo 2 opções",
    language: "Idioma",
    questionPlaceholder: "Qual é a sua idade?",
    ...
    pressStart: "Prima Iniciar para mostrar a primeira pergunta.",
    addInSetup: "Adicione perguntas na Preparação primeiro.",
    screenHidden: "Ecrã oculto",
    screenHiddenNote: "O público vê um ecrã de espera. Mostre outra vez quando quiser.",
    attendeesHint: "Os participantes abrem a página no telemóvel",
  ...
  es: {
    ...
    language: "Idioma",
    questionPlaceholder: "¿Cuál es tu edad?",
    optionsPlaceholder: "Menos de 30\n30–50\nMás de 50",
    ...
    attendeesHint: "El público abre la página en su móvil",
  ...
  fr: {
    ...
    addOptionsFirst: "Ajoutez des options ci-dessus pour en marquer une.",
    addQuestion: "Ajouter la question",
    saveChanges: "Enregistrer",
    cancel: "Annuler",
    noQuestionsYet: "Aucune question — ajoutez la première ci-dessus.",
    optionsCount: "{n} options",
    needTwoOptions: "2 options minimum",
    language: "Langue",
    questionPlaceholder: "Quel est votre âge ?",
    ...
    pressStart: "Appuyez sur Démarrer pour afficher la première question.",
    addInSetup: "Ajoutez d'abord des questions dans Préparation.",
    screenHidden: "Écran masqué",
    screenHiddenNote: "Le public voit un écran d'attente. Affichez-le quand vous voulez.",
    attendeesHint: "Le public ouvre la page sur son téléphone",
  ...
  de: {
    ...
    addOptionsFirst: "Fügen Sie oben Antworten hinzu, um eine zu markieren.",
    addQuestion: "Frage hinzufügen",
    saveChanges: "Änderungen speichern",
    cancel: "Abbrechen",
    noQuestionsYet: "Noch keine Fragen — fügen Sie oben die erste hinzu.",
    optionsCount: "{n} Antworten",
    needTwoOptions: "Mind. 2 Antworten",
    language: "Sprache",
    questionPlaceholder: "Wie alt sind Sie?",
    ...
    pressStart: "Auf Start tippen, um die erste Frage zu zeigen.",
    addInSetup: "Fügen Sie zuerst Fragen in der Vorbereitung hinzu.",
    screenHidden: "Bildschirm ausgeblendet",
    screenHiddenNote: "Das Publikum sieht einen Wartebildschirm. Jederzeit wieder einblenden.",
    attendeesHint: "Das Publikum öffnet die Seite auf dem Handy",
