...
let s = await run({ build: ["polls", "timer", "qr", "icons", "gate", "applause", "sheet", "pollpicker", "pause", "scores", "bigscreen", "speed", "signin", "presence", "tour", "version", "clearroom"] });
...
let t = await run({ build: ["polls", "timer", "qr", "icons", "gate", "applause", "sheet", "pollpicker", "pause", "scores", "bigscreen", "speed", "signin", "presence", "tour", "version", "clearroom"], styled: "" });
